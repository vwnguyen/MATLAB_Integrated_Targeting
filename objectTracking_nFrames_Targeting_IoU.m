...
coder.varsize('ref_n_frame_axies_flatten', [ 50 4 ] );
...
curr_frame_axies = [];
coder.varsize('curr_frame_axies', [ 50 4 ] );
curr_frame_labels = [];
...
for z = 1:1e5
    ...
    [ label_cnt,curr_frame_labels,curr_frame_axies,bboxes,ref_n_frame_labels_flatten,ref_n_frame_axies_flatten ] = ...
     trackCurrentObjects_IoU(min_distance,label_cnt,curr_frame_labels,curr_frame_axies,...
     bboxes,ref_n_frame_labels_flatten,ref_n_frame_axies_flatten);
